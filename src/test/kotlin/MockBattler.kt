...
class MockBattler(
    ...
    override var sleepResolutionMaximum: Int = 1,
    ...
    override var stopSpellResolutionMaximum: Int = 1,
    override var stopSpellResolutionMinimum: Int = 0,
    override val strength: Int = Random.nextInt(0, 10),
    override var turnsSleep: Int = Random.nextInt(0, 1),
    override var turnsSleepMaximum: Int = 1,
    override var turnsSleepMinimum: Int = 0,
    override var turnsStopSpell: Int = Random.nextInt(0, 1),
    override var turnsStopSpellMaximum: Int = 1,
